...
class SolarPreprocessor(Pipeline):
    def __init__(self, *args, **kwargs):
        pipeline = build_preprocessing_pipeline(*args, **kwargs)
        super().__init__(steps=pipeline.steps)

    def save_scalers(self, output_dir: str):
        self.named_steps['scaler'].save_scalers(output_dir)

    def load_scalers(self, input_dir: str):
        self.named_steps['scaler'].load_scalers(input_dir)
